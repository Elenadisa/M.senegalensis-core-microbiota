...
#Chao Plot
alpha_bact_senegal <- alpha_diversity_plot(physeq.senegal, "Microhabitat", metrics, my_comparisons_microhabitat, stat_metrics, asterisk = FALSE, "Senegal") + theme(strip.text = element_blank(), axis.title.y=element_blank())
alpha_bact_senegal
...
#Chao Plot
alpha_bact_spain <- alpha_diversity_plot(physeq.spain, "Microhabitat", metrics, my_comparisons_microhabitat, stat_metrics, asterisk = FALSE, "Spain") + theme(strip.text = element_blank(), axis.title.y=element_blank())
alpha_bact_spain
...
#Chao Plot
alpha_bact_under <- alpha_diversity_plot(physeq.understory, "Country", metrics, my_comparisons_country, stat_metrics, asterisk = FALSE, "Under") + theme(strip.text = element_blank(), axis.title.y=element_blank())
alpha_bact_under
...
capture.output(bray_permanova, file = "permanova_ITS_braydistance.txt")
