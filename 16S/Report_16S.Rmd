...
As we can see in the table there are not significant differences in terms of the number of different families in the microhabitats of the same country, but there are between the different countries.
...
ggarrange(senegal.daa.barplot, spain.daa.barplot, widths = c(1, 0.8))
```
...
```{r DAABarplotMicrohabitat, fig.width=20, fig.height=10}
...
plt_senegal <- ggplot(df.senegal.mean, aes(x = Understory, y = Gap)) +
  ...
  geom_vline(xintercept = 0.14, linetype = "dashed", color = "darkgreen", size = 1) +
  geom_hline(yintercept = 0.14, linetype = "dotted", color = "blue", size = 1) +
